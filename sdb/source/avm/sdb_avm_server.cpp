...
namespace {
    ...
    constexpr sm::ServiceName AvmServiceName = sm::ServiceName::Encode("avm");
    constexpr size_t          AvmServiceMaxSessions = 3;
    
    static constexpr size_t MaxSessions = AvmServiceMaxSessions;
